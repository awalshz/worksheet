...
$c_Lcalculator_Calculator$.prototype.init___ = (function() {
  ...
  this.nan$1 = new $c_Lcalculator_Signal().init___F0(expr);
  return this
});
...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    ...
    if ($is_Lcalculator_Literal(x1)) {
      ...
      var name = x3.name$2;
      var temp$expr = $as_Lcalculator_Expr($as_Lcalculator_Signal(references.withDefaultValue__O__sci_Map(this.nan$1).apply__O__O(name)).apply__O());
      var temp$references = references.updated__O__O__sci_Map(name, this.nan$1);
      expr = temp$expr;
      ...
      var a$4 = x7.a$2;
      var b$4 = x7.b$2;
      return ((this.eval__Lcalculator_Expr__sci_Map__D(b$4, references) === 0) ? (NaN) : (this.eval__Lcalculator_Expr__sci_Map__D(a$4, references) / this.eval__Lcalculator_Expr__sci_Map__D(b$4, references)))
    } else {
      throw new $c_s_MatchError().init___O(x1)
    }
  }
...
$c_Lcalculator_Polynomial$.prototype.computeDelta__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$1, b$1, c$1) {
    return (function() {
      var a_ = $uD(a$1.apply__O());
      var b_ = $uD(b$1.apply__O());
      var c_ = $uD(c$1.apply__O());
...
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(remainingCharsCount$1) {
    return (function() {
      var r = $uI(remainingCharsCount$1.apply__O());
      return ((r >= 15) ? "blue" : ((r < 0) ? "red" : "orange"))
    })
  })(remainingCharsCount));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
...
$c_Lcalculator_Calculator$$anonfun$computeValues$2.prototype.apply__T2__T2 = (function(x$1) {
  if ((x$1 !== null)) {
    var str = $as_T(x$1.$$und1$f);
    var sig = $as_Lcalculator_Signal(x$1.$$und2$f);
    $m_Lcalculator_Signal$();
    var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, str$1, sig$1) {
      return (function() {
        return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr(sig$1.apply__O()), arg$outer.namedExpressions$1$f.updated__O__O__sci_Map(str$1, $m_Lcalculator_Calculator$().nan$1))
      })
    })(this, str, sig));
